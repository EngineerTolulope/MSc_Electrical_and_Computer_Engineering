...
public class Paillier {
    ...
    /**
     * @ClassName: PublicKey
     * @Description: This is a class for storing the public key (n, g) of
     * Paillier PKE.
     */
     ...
     * @Description: This is a class for storing the private key (lambda, mu) of
     * Paillier PKE.
     */
    ...
    /**
     * @Title: getPubkey
     * @Description: This function returns the generated public key.
    ...
    /**
     * @Title: getPrikey
     * @Description: This function returns the generated private key.
    ...
    /**
     * @Title: keyGeneration
     * @Description: This function is to help generate the public key and
     * private key for encryption and decryption.
     * @param k k is the security parameter, which decides the length of two
    ...
    /**
     * @Title: encrypt
     * @Description: This function is to encrypt the message with Paillier’s
     * public key.
     * @param m The message.
     * @param pubkey The public key of Paillier PKE.
     * @return BigInteger The ciphertext.
     * @throws Exception If the message is not in Z*_n, there is an exception.
     */
     ...
     * @param pubkey The public key of Paillier PKE.
     * @param prikey The private key of Paillier PKE.
     * @return BigInteger The plaintext.
     * @throws Exception If the cipher is not in Z*_(n^2), there is an
     * exception.
     */
     ...
     * @param c The ciphertext.
     * @param r A random number in Z*_n.
     * @param pubkey The public key of Paillier PKE.
    ...
    /**
     * @Title: Lfunction
     * @Description: This function is the L function which is defined by
     * Paillier PKE, L(mu)=(mu-1)/n.
     * @param mu The input parameter.
     * @param n n=p*q.
    ...
    /**
     * @Title: randomZStarN
     * @Description: This function returns a ramdom number in Z*_n.
     * @param n n=p*q.
     ...
     * @Description: This function is to test whether the plaintext is in Z*_n.
     * @param m The plaintext.
     * @param n n=p*q.
     ...
     * @Description: This function is to test whether the ciphertext is in
     *
     * Z*_(n^2).
     * @param c The ciphertext.
     * @param nsquare nsquare=n^2.
     * @return boolean If it is true, the ciphertext is Z*_(n^2), otherwise,
     * not.
     */
    ...
    public static void main(String[] args) {
        ...
        BigInteger m = new BigInteger(text.next().getBytes()); //m = new BigInteger(new String("Hello").getBytes());
        BigInteger c = null;
        String tmp;
        BigInteger decrypted_m = null;
        try {
            c = Paillier.encrypt(m, pubkey);
            tmp = String.valueOf(c).substring(0, 10);
            System.out.println("The ciphertext is:- " + tmp + "...");
            decrypted_m = Paillier.decrypt(c, pubkey, prikey);
            //Get decrypted message back in text
            tmp = new String(decrypted_m.toByteArray());
            System.out.println("Decrypted message is:- " + tmp);
        } catch (Exception e) {
        ...
        BigInteger m1 = new BigInteger(text.next());
        System.out.print("Give me a new number:- ");
        BigInteger m2 = new BigInteger(text.next());
        BigInteger m1plusm2 = m1.add(m2);
        System.out.println("Message sum (m1plusm2):- " + m1plusm2);
        try {
            ...
            //
            tmp = String.valueOf(c1mulc2).substring(0, 10);
            System.out.println("Encrypted add.(c1mulc2):- " + tmp + "...");
            BigInteger decrypted_c1mulc2 = Paillier.decrypt(c1mulc2, pubkey, prikey);
            System.out.println("Decrypted addition:- " + decrypted_c1mulc2);
        ...
        m1 = new BigInteger(text.next());
        System.out.print("Give me a new number:- ");
        m2 = new BigInteger(text.next());
        BigInteger m1mulm2 = m1.multiply(m2);
        System.out.println("Message multi. (m1mulm2):- " + m1mulm2);
        try {
            BigInteger c1 = Paillier.encrypt(m1, pubkey);
            BigInteger c1expm2 = Paillier.mul(c1, m2, pubkey);
            tmp = String.valueOf(c1expm2).substring(0, 10);
            System.out.println("Encrypted multi.(c1expm2):- " + tmp + "...");
            BigInteger decrypted_c1expm2 = Paillier.decrypt(c1expm2, pubkey, prikey);
            System.out.println("Decrypted multi.:- " + decrypted_c1expm2);
        ...
        tmp = String.valueOf(r2).substring(0, 10);
        System.out.println("Random number(r2):- " + tmp + "...");
        try {
            BigInteger c1 = Paillier.encrypt(m1, pubkey);
            BigInteger c1mulrn = Paillier.selfBlind(c1, r2, pubkey);
            tmp = String.valueOf(c1mulrn).substring(0, 10);
            System.out.println("Encrypted multi.(c1mulr2):- " + tmp + "...");
            BigInteger decrypted_c1mulrn = Paillier.decrypt(c1mulrn, pubkey, prikey);
            System.out.println("Decrypted multi.:- " + decrypted_c1mulrn);
