...
public class BGN {
     ...
     * @param k the security parameter, which decides the length of two large
     * prime (p and q).
     * @return void
     */
     ...
     * @param m The message
     * @param pubkey The public key of BGN PKE.
     * @return Element The ciphertext.
     * @throws Exception If the plaintext is not in [0,1,2,...,n], there is an
     * exception.
     */
     ...
     * @param pubkey The public key of BGN PKE.
     * @param prikey The private key of BGN PKE.
     ...
     * @param pubkey The public key of BNG PKE.
     ...
     * @param c The ciphertext.
     * @param r A random number in Z_n.
     * @param pubkey The public key of BNG PKE.
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("The Cipher Text:- " + tmp +"...");
        ...
        try {
            ...
            System.out.println("Decrypted Add.(m1+m2):- " +decrypted_c1mulc2);
        ...
        try {
            ...
            System.out.println("Encrypted Mul.(c1expm2):- " + tmp + "...");
            int decrypted_c1expm2 = BGN.decrypt(c1expm2, pubkey, prikey);
            System.out.println("Decrypted Mul.(m1*m2):- " +decrypted_c1expm2);
        ...
        try {
            ...
            tmp = String.valueOf(c1pairingc2).substring(0,13);
            System.out.println("Encrypted Pair.(c1pairingc2):- " + tmp + "...}");
            int decrypted_c1pairingc2 = BGN.decrypt_mul2(c1pairingc2, pubkey, prikey);
            System.out.println("Decrypted Mul.(m1*m2):- " +decrypted_c1pairingc2);
        ...
        try {
            ...
            tmp = String.valueOf(c1_selfblind).substring(0, 10);
            System.out.println("Encrypted multi.(c1_selfblind):- " + tmp + "...");
            int decrypted_c1_selfblind = BGN.decrypt(c1_selfblind, pubkey, prikey);
            System.out.println("Decrypted m1:- " + decrypted_c1_selfblind);
