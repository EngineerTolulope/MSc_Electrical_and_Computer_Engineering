...
% To test the rocket_velocity.m function
i=1;
for t=-5:0.1:50;
...
% e_s = 0.5*10^(2-n);  % Calculating the tolerance based on the value of n
% e_a=100;    % setting the approximate relative errors to 100% or (1+e_s)
