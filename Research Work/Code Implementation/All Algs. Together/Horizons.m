...
testdata = testdata(TR, :);   % testing data 
...
%% CNN and Actuals Plot
figure;

% plot actual values
plot(ANNdt, testdata.DemandMW(ANNdt), 'DisplayName','Actual Values')
...
% plot rls forecast
plot(ANNdt,PredCNN(:), 'DisplayName', 'CNN Forecast' )
xlabel('Date and Time of Occurrence')
ylabel('Load Demand in Megawatts')
legend('show', 'Location','northwest')

%% Specific Month Plots
TR = timerange('2019-07-17','2019-07-20 23:00:00', "closed");
...
xlabel('Weekdays')
ylabel('Average Load Demand in Megawatts')
legend('Average Daily Values', 'CNN', 'LSTM', 'ANN', 'MLR', 'ARIMA', 'SNF', 'Location','best')
