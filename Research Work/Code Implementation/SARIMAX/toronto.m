...
fitd = demand(:,180);
fitd(:, 2) = temperature(:,180);

%% Getting the data ready
% w=5;Y = buffer(demandMW.DemandMW,24*7*w,24*7*w-24);

TR = timerange('2018-12-04','2020-01-01');  % All of 2019
...
TR = timerange('2018-12-31','2020-01-01');   % 
...
clear yARIMA
for i = 1:(width(demand) - 1)
    Tmp_Model = TorontoModeller([demand(:, i), temperature(:, i)]);
